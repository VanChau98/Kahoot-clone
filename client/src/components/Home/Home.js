      ...
      <section className={styles["page-section"]}>
        ...
        <section className={styles["second-section"]}>
          ...
          <div className={styles.info}>
            <div className={styles["info-body"]}>
              <h2 className={styles["info-title"]}>
                {isLanguageEnglish ? "Kahoot! at school" : "Kahoot w szkole"}
              </h2>
          ...
          <div className={styles.info}>
            <div className={styles["info-body"]}>
              <h2 className={styles["info-title"]}>
                {isLanguageEnglish ? "Kahoot! at work" : "Kahoot w pracy"}
              </h2>
              <p className={styles["info-description"]}>
                {isLanguageEnglish
          ...
          <div className={styles.info}>
            <div className={styles["info-body"]}>
              <h2 className={styles["info-title"]}>
                {isLanguageEnglish ? "Kahoot! at home" : "Kahoot w domu"}
              </h2>
              <p className={styles["info-description"]}>
                {isLanguageEnglish
          ...
          <div className={styles.info}>
            <div className={styles["info-body"]}>
              <h2 className={styles["info-title"]}>
                {isLanguageEnglish ? "Kahoot Academy" : "Kahoot w domu"}
              </h2>
              <p className={styles["info-description"]}>
                {isLanguageEnglish
                  ? "Learning Apps and games for family fun or home study."
